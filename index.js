...
app.post('/analyze', upload.single('image'), async (req, res) => {
    ...
    function formatResult(text) {
        ...
        const parts = text.split(/Species Identification:|Plant Health:|Care Recommendations:|Characteristics:/);
...
app.post('/download', express.urlencoded({ extended: true }), async (req, res) => {
    ...
    try {
        ...
        const parts = cleanText.split(/Species Identification:|Plant Health:|Care Recommendations:|Characteristics:/);
